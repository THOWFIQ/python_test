...
Error in combined_foid_fetch: 'NoneType' object is not subscriptable
[FATAL ERROR] in fieldValidation: 'work'
...
def combined_foid_fetch(fo_id, region, filters, CollectedValue):
    try:
        ...
        foid_records = combined_foid_data['data'].get('getAllFulfillmentHeadersByFoId', [])
        if foid_records:
...
if __name__ == "__main__":
    ...
    output = fieldValidation(sample_filters,region,format_type)
    flat_table = OutputFormat(output)
